...
// Captura o evento de input p/ formatar o valor.
amount.oninput = () => {
...
// Captura o evento de submit do formulário para obter as valores.
form.onsubmit = (event) => {
...
function expenseAdd(newExpense) {
  try {
    ...
    // Limpa o formulário para adicionar um novo ítem.
    formClear()
...
function updateTotals() {
  try {
    ...
    // Variável para incrementar o total de despesas no valor.
    let total = 0
    ...
    for(let item = 0; item < items.length; item++) {
      ...
      // Remove caracteres não numéricos e subistitui a vírgula por ponto.
    ...
    // Formata o valor e remove o R$ que sera exibido oela small com estilo customizado.
